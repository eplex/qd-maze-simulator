...
namespace SharpNeatLib.Evolution
{
	public class Species
	{
        ...
        public SortedDictionary<double, double> Centroid; // JUSTIN: Used for k-means speciation. Key: Connection ID, Value: Connection weight (average value of all species members). Keys not present are assumed to be 0.
