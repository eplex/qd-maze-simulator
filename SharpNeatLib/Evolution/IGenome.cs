...
namespace SharpNeatLib.Evolution
{
	...
	public interface IGenome : IComparable
	{
        ...
        /// <summary>
        /// JUSTIN: This genome's fitness score before any normalization (e.g. through speciation fitness sharing) is applied.
        /// </summary>
        double FitnessBeforeNormalization
        {
            get;
            set;
        }
