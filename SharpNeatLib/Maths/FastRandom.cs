...
//		}
        ...
        // (Copy method, added by Justin)
        // I don't fully understand this class, but surely copying over all the state variables will do the trick..
        public FastRandom copy()
        {
            FastRandom ret = new FastRandom();
            ret.x = x;
            ret.y = y;
            ret.z = z;
            ret.w = w;
