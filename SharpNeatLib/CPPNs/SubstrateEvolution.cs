                                                ...
                                                ref  ConnectionGeneList connections, ref List<PointF> hiddenNeurons, float stackNumber)
        {
          ...
          //  totalLength = 0.0f;
            ...
            foreach (ExpressPoint t in _connections)
            {
                ...
                connections.Add(new ConnectionGene(counter++, (uint)(sourceIndex), (uint)(targetIndex + inputCount + outputCount), weight, ref connectionCoordinates));
                //   }
            ...
            foreach (ExpressPoint t in _connections)
            {
                ...
                connections.Add(new ConnectionGene(counter++, (uint)(sourceIndex + inputCount + outputCount), (uint)(targetIndex + inputCount + outputCount), weight, ref connectionCoordinates));
                //   }
            }
            ...
            foreach (ExpressPoint t in _connections)
            {
                ...
                if (sourceIndex != -1)
                {
                    ...
                    connections.Add(new ConnectionGene(counter++, (uint)(sourceIndex + inputCount + outputCount), (uint)(targetIndex + inputCount), weight, ref connectionCoordinates));
                }
                // }
